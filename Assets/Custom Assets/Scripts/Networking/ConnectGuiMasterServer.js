...
var gameName = "Default Game Name";
...
private var useNatPunchThrough = false;		// Should the server enabled NAT punchthrough feature
...
{
//	print("onfailedmasterserver");
	Debug.Log(info);
}

function OnFailedToConnect(info: NetworkConnectionError)
{
//	print("onfailedconnect");
	Debug.Log(info);
}
...
{	
	...
	if (Network.peerType == NetworkPeerType.Disconnected)
	{
		...
		{
			Network.InitializeServer(32, serverPort, useNatPunchThrough);
			MasterServer.RegisterHost(gameName, "Generals", "Generals Community test");
		}
...
function MakeClientWindow(id : int)
{
	...
	for (var element in data)
	{
		...
		if ( !(filterNATHosts && element.useNatPunchThrough) )
		{
